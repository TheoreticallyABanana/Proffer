...
using Proffer.Data;
using Proffer.Models.ApiModels;
...
namespace Proffer.Controllers
{
    public class ProductModelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Description")] ProductModel productModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Price,Description")] ProductModel productModel)
        {
